...
<section>
	<fieldset class="flex flex-col gap-3">
		...
		<p class="text-muted-foreground text-sm">Select the theme that matches your style.</p>
		<RadioGroup.Root class="grid gap-3 md:grid-cols-3" value={userPrefersMode.current}>
