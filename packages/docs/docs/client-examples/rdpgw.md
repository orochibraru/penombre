---
title: RDP Gateway
description: Set up RDP Gateway with Opendrive authentication
---
...
3. Set the callback URL to: `https://rd.example.com/callback`, or leave blank to autofill on first login.
