---
title: Grafana
description: Configure Grafana OIDC with Opendrive
---

Below URLs are used as placeholders for the Grafana and Opendrive instances. Replace them with the actual URLs.
...
1. In Opendrive, create a new OIDC client named `grafana` (or any name you prefer).
...
3. Enter the values for the fields as given below in the **General Settings**:
   - `Display Name` as 'Opendrive' or something similar.
