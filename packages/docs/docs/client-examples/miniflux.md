---
title: Miniflux
description: Configure Miniflux RSS reader with Opendrive
---

1. Create a new OIDC Client in Opendrive (e.g., `miniflux`).
...
4. Set the following environment variables in your Miniflux instance:
   ...
   OAUTH2_OIDC_DISCOVERY_ENDPOINT=https://<Opendrive DOMAIN> # no trailing slashes or ".well-known/openid-configuration"
