---
title: Forgejo
description: Configure Forgejo Git service with Opendrive
---

## Opendrive Setup

1. In Opendrive, create a new OIDC client named `Forgejo` (or any name you prefer).
...
5. Set **Authentication Name** to `PocketID`.
   > [!IMPORTANT]
   > If you change this name, update the callback URL in Opendrive to match.
