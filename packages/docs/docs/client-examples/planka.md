---
title: Planka
description: Configure Planka project management with Opendrive
---
...
1. Create a new OIDC Client in Opendrive (e.g., `planka`).
...
To control **admin** access to Planka using Opendrive groups:
...
1. Set the following additional environment variables in your Planka instance:
   ...
   OIDC_ADMIN_ROLES=<your Planka admin group name on Opendrive>
   ```
