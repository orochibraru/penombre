---
title: Actual Budget
description: Integrate Opendrive with Actual Budget
---
...
1. Create a new OIDC Client in Opendrive (e.g., `actual`).
...
3. Fill in the required fields:
   ...
   - **Provider URL**: Paste either your base `Pocket URL` or `OIDC Discovery URL` from Opendrive.
