---
title: Open WebUI
description: Configure Open WebUI with Opendrive authentication
---
...
```ini
  ...
  OAUTH_CLIENT_ID=<client id from Opendrive>
  OAUTH_CLIENT_SECRET=<client secret from Opendrive>
  OAUTH_PROVIDER_NAME="Opendrive"
  OPENID_PROVIDER_URL=https://<your Opendrive url>/.well-known/openid-configuration
