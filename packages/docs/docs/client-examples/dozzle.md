---
title: Dozzle
description: Integrate Dozzle authentication with Opendrive
---

## Requirements

- [Dozzle](https://github.com/amir20/dozzle) setup with [Forward Proxy authentication](https://dozzle.dev/guide/authentication)
- HTTPS connection to your Opendrive server

### Setting up Dozzle with Opendrive
...
1. Create a new OIDC client in Opendrive for Dozzle:
   - **Name:** `Dozzle`
...
4. Create the oauth2-proxy config file.
   ...
   ```toml
    client_id = "xxx"                            # from Opendrive
    client_secret = "xxx"                        # from Opendrive
    ...
    provider_display_name = "Opendrive"          # display name for OIDC login
