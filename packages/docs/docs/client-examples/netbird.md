---
title: NetBird
description: Configure NetBird (using ZITADEL) with Opendrive OIDC
---

## Requirements

- NetBird self-hosted configured using HTTPS
- Opendrive configured with HTTPS
...
This guide will show you how to configure **pass-through OpenID authentication** via ZITADEL, back to Opendrive.

_Note:_ Changing the NetBird IDP _directly_ to Opendrive from ZITADEL is **not** covered in this guide because of the complexity.

## Configure OIDC Client

Create a regular application in Opendrive.
...
## Connect ZITADEL / NetBird to Opendrive

Next we will connect ZITADEL IdP to Opendrive for pass through:
...
- Set the **Issuer** to your main Opendrive URL (i.e.: `https://id.example.com`)
...
- Click **Save**
- Click **Activate**
- Test to confirm that you can successfully login to ZITADEL with your Opendrive
