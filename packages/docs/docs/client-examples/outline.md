---
title: Outline
description: Set up Outline wiki with Opendrive OIDC
---

Setting up [Outline](https://docs.getoutline.com/s/hosting/doc/oidc-8CPBm6uC0I) to authenticate with Opendrive can be accomplished with the configuration below.

Your Outline and Opendrive server URLs must both use HTTPS.

## Create OIDC Client

1. Login to your **Opendrive** server as an admin
...
1. Login to **Outline** with your Opendrive
