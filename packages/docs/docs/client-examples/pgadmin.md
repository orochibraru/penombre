---
title: pgAdmin
description: Configure pgAdmin with Opendrive authentication
---
...
**Make sure to replace https://id.example.com with your actual Opendrive URL**
