---
title: Paperless-ngx
description: Set up Paperless-ngx with Opendrive OIDC
---

Below URLs are used as placeholders for the paperless-ngx and Opendrive instances. Replace them with the actual URLs.
...
1. In Opendrive, create a new OIDC client named `paperless-ngx` (or any name you prefer).
...
4. To allow for your existing paperless-ngx user ID to be linked to the user in Opendrive
   ...
   - Link the account to Opendrive using the **Connect new social account** option.
