---
title: Rallly
description: Configure Rallly scheduling with Opendrive
---

Below URLs are used as placeholders for the rallly and Opendrive instances. Replace them with the actual URLs.
...
1. In Opendrive, create a new OIDC client named `rallly` (or any name you prefer).
...
Restart your docker containers and you should be able to login to rallly using Opendrive.
