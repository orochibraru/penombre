...
6. [Backup & Restore](backup.md) — the backup and restore scripts.
7. [Reverse proxy](reverse-proxy.md) — HTTPS with Caddy, Nginx, or Traefik.
8. [Troubleshooting](troubleshooting.md) — fixes for the errors you're likely to
   hit.
9. [Authentication](authentication.md) — passwords, OAuth, passkeys, API keys.
10. [Project architecture](architecture.md) — how the monorepo fits together.
