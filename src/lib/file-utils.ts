import { type SupportedLanguage, supportedLanguages } from '$lib/components/ui/code/shiki';
...
export const codeFileNames = ['Dockerfile', 'Taskfile', 'Makefile', 'Caddyfile', '.env'];
