...
#
# Format: VOLUME_<NAME>_PATH, plus optional _LABEL, _READONLY and _SHARED.
# In simple mode a volume is shared whole by every account; in full mode each
# user gets their own subdirectory of it, exactly like the main drive — so an
# existing library mounted in full mode looks empty until _SHARED=true serves
# the whole tree to everybody.
#
